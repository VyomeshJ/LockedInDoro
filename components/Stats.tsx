  ...
  if (!isLoggedIn) {
    return (
      <div className="w-full h-full flex flex-col items-center justify-center px-6 gap-6 text-center">
        <h1 className="font-pixel text-7xl shrink-0">Stats</h1>
        <div className="max-w-xl w-full p-6 rounded-xl bg-[#182229] flex flex-col items-center gap-4">
          <span className="font-pixel text-2xl">Want to see your stats?</span>
    ...
    <div className="w-full h-full flex flex-col items-center px-6 gap-8 min-h-0">
      ...
      <div className="w-full max-w-xl flex flex-col gap-6 font-pixel text-2xl flex-1 min-h-0">
        <div className="grid grid-cols-2 gap-4 shrink-0">
          <div className="flex flex-col gap-2 p-4 rounded-xl bg-[#182229]">
            <span className="text-xl opacity-80">Total Studied</span>
        ...
        <div className="flex flex-col gap-4 p-4 rounded-xl bg-[#182229] flex-1 min-h-0">
          <div className="flex justify-between items-center shrink-0">
            <span className="text-2xl">This Week</span>
            <span className="text-lg opacity-80">Minutes studied</span>
          </div>
